...
public class RETC_047 {
	...
	public void validLoginTest() throws InterruptedException {
		...
		Thread.sleep(5000);
		driver.findElement(By.id("property_feature-add-toggle")).click();
		Thread.sleep(4000);
		driver.findElement(By.name("newproperty_feature")).sendKeys("Best");
		Thread.sleep(4000);
		Select s1 = new Select(driver.findElement(By.name("newproperty_feature_parent")));
		s1.selectByValue("435");
		Thread.sleep(4000);
